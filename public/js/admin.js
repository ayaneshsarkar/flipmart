...
var productImageCross = document.querySelectorAll('.productImageCross');

if (productImageCross) {
  productImageCross.forEach(function (cross) {
    cross.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var productId, imageId, id, status;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              productId = cross.getAttribute('data-product') || null;
              imageId = cross.getAttribute('data-image') || null;
              id = document.getElementById(imageId);
              _context.next = 5;
              return Object(_components_product__WEBPACK_IMPORTED_MODULE_3__["deleteProductImage"])(productId, imageId);
...
var alerts = document.querySelectorAll('.alertswal');
  ...
  alerts.forEach(function (alert) {
    alert.addEventListener('click', function (e) {
      ...
      sweetalert__WEBPACK_IMPORTED_MODULE_2___default()({
        ...
        if (willDelete) {
          var link = alert.getAttribute('href');
...
if (adminLogout) {
  adminLogout.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
    var res;
